...
function WW() {
  ...
  const movieCollections = {
    ...
    "Game Changer": [
      { region: "Nizam", collections: "10.94CR" },
      { region: "Ceeded", collections: "5.82CR" },
      { region: "UA", collections: "5.64Cr" },
      { region: "East", collections: "4.85Cr" },
      { region: "West", collections: "2.42" },
      { region: "Guntur", collections: "4.36Cr" },
      { region: "Krishna", collections: "3.12Cr" },
      { region: "Nellore", collections: "2.37Cr" },
      { region: "AP-TG Total", collections: "39.52Cr" },
